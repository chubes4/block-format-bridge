...
class HTML_To_Blocks_Transform_Registry {
	...
	private static function create_code_window_text_group($element): array {
		...
		return HTML_To_Blocks_Block_Factory::create_block('core/group', $attrs, array(
			HTML_To_Blocks_Block_Factory::create_block('core/paragraph', array(
