...
final class TableExtension implements ConfigurableExtensionInterface {
	...
	public function configureSchema(ConfigurationBuilderInterface $builder): void {
		...
		$builder->addSchema('table', Expect::structure(array(
			'wrap'                    => Expect::structure(array(
				'enabled'    => Expect::bool()->default(\false),
				'tag'        => Expect::string()->default('div'),
				'attributes' => Expect::arrayOf(Expect::string()),
			)),
			'alignment_attributes'    => Expect::structure(array(
				'left'   => ( clone $attributeArraySchema )->default(array( 'align' => 'left' )),
				'center' => ( clone $attributeArraySchema )->default(array( 'align' => 'center' )),
				'right'  => ( clone $attributeArraySchema )->default(array( 'align' => 'right' )),
			)),
