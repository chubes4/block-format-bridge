...
final class ExternalLinkExtension implements ConfigurableExtensionInterface {
	...
	public function configureSchema(ConfigurationBuilderInterface $builder): void {
		$applyOptions = array( ExternalLinkProcessor::APPLY_NONE, ExternalLinkProcessor::APPLY_ALL, ExternalLinkProcessor::APPLY_INTERNAL, ExternalLinkProcessor::APPLY_EXTERNAL );
		$builder->addSchema('external_link', Expect::structure(array(
