...
final class CommonMarkCoreExtension implements ConfigurableExtensionInterface {
	...
	public function configureSchema(ConfigurationBuilderInterface $builder): void {
		$builder->addSchema('commonmark', Expect::structure(array(
			'use_asterisk'           => Expect::bool(\true),
			'use_underscore'         => Expect::bool(\true),
			'enable_strong'          => Expect::bool(\true),
			'enable_em'              => Expect::bool(\true),
			'unordered_list_markers' => Expect::listOf('string')->min(1)->default(array( '*', '+', '-' ))->mergeDefaults(\false),
		)));
	}
