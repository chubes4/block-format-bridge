...
final class TableOfContentsExtension implements ConfigurableExtensionInterface {
	...
	public function configureSchema(ConfigurationBuilderInterface $builder): void {
		$builder->addSchema('table_of_contents', Expect::structure(array(
	...
	public function register(EnvironmentBuilderInterface $environment): void {
		...
		$environment->addEventListener(DocumentParsedEvent::class, array( new TableOfContentsBuilder(), 'onDocumentParsed' ), -150);
