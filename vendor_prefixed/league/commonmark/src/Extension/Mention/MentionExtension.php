...
final class MentionExtension implements ConfigurableExtensionInterface {
	...
	public function configureSchema(ConfigurationBuilderInterface $builder): void {
		...
		$builder->addSchema('mentions', Expect::arrayOf(Expect::structure(array(
			...
			'generator' => Expect::anyOf(Expect::type(MentionGeneratorInterface::class), Expect::string(), Expect::type('callable'))->required(),
		))));
	}
