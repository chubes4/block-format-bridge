...
final class StringContainerHelper {
	 ...
	 */
	public static function getChildText(Node $node, array $excludeTypes = array()): string {
		$text = '';
	 ...
	 * @psalm-pure
	 */
	private static function isOneOf(object $object_value, array $classesOrInterfacesToCheck): bool {
		foreach ( $classesOrInterfacesToCheck as $type ) {
			if ( $object_value instanceof $type ) {
				return \true;
			}
		}
		return \false;
