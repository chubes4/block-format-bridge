...
final class MarkdownParser implements MarkdownParserInterface {
	 ...
	 * @psalm-readonly-allow-private-mutation
	 */
	private array $activeBlockParsers = array();
	/**
	 * @var array<int, BlockContinueParserWithInlinesInterface>
	 *
	 * @psalm-readonly-allow-private-mutation
	 */
	private array $closedBlockParsers = array();
	...
	private function initialize(): void {
		...
		$this->lineNumber         = 0;
		$this->activeBlockParsers = array();
		$this->closedBlockParsers = array();
	...
	private function parseLine(string $line): void {
		...
		while ( $tryBlockStarts ) {
			...
			if ( null === $blockStart || $blockStart->isAborting() ) {
	...
	private function parseBlockContinuation(): ?int {
		...
		$matches    = 1;
		$this_count = count($this->activeBlockParsers);
