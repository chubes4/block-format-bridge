...
class Paginator {
	...
	public function getLastPage(): ?int {
		return null === $this->itemCount ? null : $this->base + max(0, $this->getPageCount() - 1);
	}
	/**
	...
	public function getFirstItemOnPage(): int {
		return 0 !== $this->itemCount ? $this->offset + 1 : 0;
	}
	/**
	...
	protected function getPageIndex(): int {
		...
		return null === $this->itemCount ? $index : min($index, max(0, $this->getPageCount() - 1));
	}
	public function isFirst(): bool {
		return $this->getPageIndex() === 0;
	}
	public function isLast(): bool {
		return null === $this->itemCount ? \false : $this->getPageIndex() >= $this->getPageCount() - 1;
	}
	/**
	 * @return ?int<0, max>
	 */
	public function getPageCount(): ?int {
		return null === $this->itemCount ? null : max(0, (int) ceil($this->itemCount / $this->itemsPerPage));
	}
	...
	public function setItemCount(?int $itemCount = null): static {
		$this->itemCount = null === $itemCount ? null : max(0, $itemCount);
		return $this;
	}
	/**
	 * @return ?int<0, max>
	...
	public function getCountdownOffset(): ?int {
		return null === $this->itemCount ? null : max(0, $this->itemCount - ( $this->getPageIndex() + 1 ) * $this->itemsPerPage);
	}
	/**
	...
	public function getLength(): int {
		return null === $this->itemCount ? $this->itemsPerPage : max(0, min($this->itemsPerPage, $this->itemCount - $this->getPageIndex() * $this->itemsPerPage));
	}
}
